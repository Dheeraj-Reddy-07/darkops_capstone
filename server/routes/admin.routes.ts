...
import { getUsers, updateUserRole, getAuditLogs, getSystemStats } from '../controllers/admin.controller';
...
router.patch('/users/:id/role', rateLimit(20, 60000), requirePermission('admin.users'), updateUserRole);
